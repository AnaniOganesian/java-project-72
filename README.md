...
[![hexlet-check](https://github.com/AnaniOganesian/java-project-72/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/AnaniOganesian/java-project-72/actions)
...
```bash
git clone https://github.com/AnaniOganesian/java-project-72.git
cd java-project-72
```
